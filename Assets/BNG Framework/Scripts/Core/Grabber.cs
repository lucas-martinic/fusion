...
namespace BNG {
    ...
    public class Grabber :  NetworkBehaviour {
        ...
        // for fusion network inputs

        public NetworkHand networkhand;
        public float RightNetworkTrigger;
        public float RightNetworkGrip;
       ...
       // {
        ...
        // getting inputs from network hand
        public void SetHand(HandCommand command)
        {
            RightNetworkGrip = command.rightGripCommand;
            RightNetworkTrigger = command.rightTriggerCommand;
        }
        ...
        {
            if (grabsInTrigger == null) return null;
        ...
        protected virtual float getGrabInput(GrabButton btn) {
            ...
            // Right Hand
                ...
                if (btn == GrabButton.GripOrTrigger) {
                    ...
                    gripValue = RightNetworkGrip;
                }
                else if (btn == GrabButton.Trigger) {
                    // gripValue = input.RightTrigger;
                    gripValue = RightNetworkTrigger;
                }
            }
