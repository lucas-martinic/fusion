...
namespace Fusion.XR.Host.Rig 
{
    ...
    public struct HandCommand : INetworkStruct
    {
        ...
        // modified inputs
        public float rightGripCommand;
        public float rightTriggerCommand;
    }
    ...
    public class HardwareHand : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            {
                handCommand.rightGripCommand = InputBridge.Instance.RightGrip;
                handCommand.rightTriggerCommand = InputBridge.Instance.RightTrigger;
            }
